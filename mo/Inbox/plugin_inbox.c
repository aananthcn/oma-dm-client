...
static int prv_findURNFN(const char *iURN, char ***oURL, void *iData)
{
...
static int prv_inboxSetFN(const dmtree_node_t * nodeP, void *data)
{
	return OMADM_SYNCML_ERROR_OPTIONAL_FEATURE_NOT_SUPPORTED;
}

static int prv_inboxGetACLFN(const char *iURI, char **oValue, void *iData)
{
