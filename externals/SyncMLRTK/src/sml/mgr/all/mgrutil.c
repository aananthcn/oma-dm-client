...
SML_API MemSize_t smlGetFreeBuffer(InstanceID_t id)
{
	...
	if (pInstanceInfo == NULL)
		return 0;	// no buffer if no instance there
	freeMem = (pInstanceInfo->instanceBuffer + pInstanceInfo->instanceBufSiz) -	// end of buffer
...
SML_API String_t smlPcdata2String(SmlPcdataPtr_t pcdata)
{
	...
	smlLibMemcpy((MemPtr_t) str, (MemPtr_t) pcdata->content,
		     pcdata->length);
	*(str + pcdata->length) = '\0';
...
SML_API SmlPcdataPtr_t smlPcdataDup(SmlPcdataPtr_t pcdata)
{
	...
	newPcdata =
	    (SmlPcdataPtr_t) smlLibMalloc((MemSize_t) sizeof(SmlPcdata_t));
	if (!newPcdata)
		return NULL;
	...
	newPcdata->content =
	    (VoidPtr_t) smlLibMalloc((MemSize_t) pcdata->length + 1);
	...
	smlLibMemcpy(newPcdata->content, pcdata->content,
		     (MemSize_t) pcdata->length);
...
SML_API void smlFreeRecordFieldFilterPtr(SmlRecordOrFieldFilterPtr_t
					 pRecordFieldFilter)
{
...
SML_API void smlFreeSourceTargetParentPtr(SmlSourceParentPtr_t
					  pSourceTargetParent)
{
...
{
	SmlRecordOrFieldFilterPtr_t p = (SmlRecordOrFieldFilterPtr_t)
	    smlLibMalloc(sizeof(SmlRecordOrFieldFilterPtr_t));
	if (p == NULL)
		return NULL;
...
{
	SmlFilterPtr_t p =
	    (SmlFilterPtr_t) smlLibMalloc(sizeof(SmlFilterPtr_t));
	if (p == NULL)
		return NULL;
...
{
	SmlSourceParentPtr_t p =
	    (SmlSourceParentPtr_t) smlLibMalloc(sizeof(SmlSourceParentPtr_t));
	if (p == NULL)
		return NULL;
...
{
	SmlSyncHdrPtr_t p =
	    (SmlSyncHdrPtr_t) smlLibMalloc(sizeof(SmlSyncHdr_t));
	if (p == NULL)
		return NULL;
...
{
	SmlItemListPtr_t p =
	    (SmlItemListPtr_t) smlLibMalloc(sizeof(SmlItemList_t));
	if (p == NULL)
		return NULL;
...
{
	SmlMapItemPtr_t p =
	    (SmlMapItemPtr_t) smlLibMalloc(sizeof(SmlMapItem_t));
	if (p == 0)
		return NULL;
...
{
	SmlResultsPtr_t p =
	    (SmlResultsPtr_t) smlLibMalloc(sizeof(SmlResults_t));
	if (p == 0)
		return NULL;
...
{
	SmlUnknownProtoElementPtr_t p = (SmlUnknownProtoElementPtr_t)
	    smlLibMalloc(sizeof(SmlUnknownProtoElement_t));
	if (p == 0)
		return NULL;
...
{
	SmlMetInfMetInfPtr_t p =
	    (SmlMetInfMetInfPtr_t) smlLibMalloc(sizeof(SmlMetInfMetInf_t));
	if (p == NULL)
		return NULL;
...
{
	SmlMetInfAnchorPtr_t p =
	    (SmlMetInfAnchorPtr_t) smlLibMalloc(sizeof(SmlMetInfAnchor_t));
	if (p == NULL)
		return NULL;
...
{
	SmlMetInfMemPtr_t p =
	    (SmlMetInfMemPtr_t) smlLibMalloc(sizeof(SmlMetInfMem_t));
	if (p == NULL)
		return NULL;
...
{
	SmlDevInfExtPtr_t p =
	    (SmlDevInfExtPtr_t) smlLibMalloc(sizeof(SmlDevInfExt_t));
	if (p == NULL)
		return NULL;
...
{
	SmlDevInfCTDataPtr_t p =
	    (SmlDevInfCTDataPtr_t) smlLibMalloc(sizeof(SmlDevInfCTData_t));
	if (p == NULL)
		return NULL;
...
{
	SmlDevInfCTDataListPtr_t p = (SmlDevInfCTDataListPtr_t)
...
{
	SmlDevInfCTDataPropPtr_t p = (SmlDevInfCTDataPropPtr_t)
...
{
	SmlDevInfCTDataPropListPtr_t p = (SmlDevInfCTDataPropListPtr_t)
...
{
	SmlDevInfXmitListPtr_t p =
	    (SmlDevInfXmitListPtr_t) smlLibMalloc(sizeof(SmlDevInfXmitList_t));
	if (p == NULL)
		return NULL;
...
{
	SmlDevInfDatastorePtr_t p = (SmlDevInfDatastorePtr_t)
	    smlLibMalloc(sizeof(SmlDevInfDatastore_t));
	if (p == NULL)
		return NULL;
...
{
	SmlDevInfDatastoreListPtr_t p = (SmlDevInfDatastoreListPtr_t)
	    smlLibMalloc(sizeof(SmlDevInfDatastoreList_t));
	if (p == NULL)
		return NULL;
