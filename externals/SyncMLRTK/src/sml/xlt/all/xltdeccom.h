 ...
 */
	typedef struct {
		XltTokType_t type;
			      /**< TOK_TAG_START, etc. */
		XltTagID_t tagid;
			      /**< TN_SYNCHDR, etc. - valid for token of type
                               *   TOK_TAG_xxx */
		SmlPcdataExtension_t ext;
			      /**< type of extension this tag belongs to -
                               *   valid for token of type TOK_TAG_xxx */
		SmlPcdataPtr_t pcdata;
			      /**< valid for token of type TOK_CONT */
		MemPtr_t start;
			      /**< pointer to the start of this token within
 ...
 */
     ...
     */
		void (*setBuf) (XltDecScannerPtr_t pScanner,
				const MemPtr_t pBufStart,
 ...
 * @return SML_ERR_OK or an appropriate error code
 */
	Ret_t xltDecWbxmlInit(const MemPtr_t pBufEnd, MemPtr_t * ppBufPos,
 ...
 */
	Ret_t xltDecXmlInit(const MemPtr_t pBufEnd, MemPtr_t * ppBufPos,
			    XltDecScannerPtr_t * ppScanner);
