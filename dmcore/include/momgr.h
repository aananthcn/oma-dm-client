...
int momgr_exists(mo_mgr_t * iMgr, const char *iUri,
...
int momgr_exec_node(mo_mgr_t * iMgr, const char *iUri, const char *iData,
		    const char *iCorrelator);

int momgr_validate_uri(mo_mgr_t * iMgr, const char *uri, char **oNodeURI,
		       char **oPropId);

int momgr_find_subtree(mo_mgr_t * iMgr, const char *iUri, const char *iUrn,
		       const char *iCriteriaName, const char *iCriteriaValue,
		       char **oUri);
